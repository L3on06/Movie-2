            ...
            {movies && movies.map(movie => (
              <div>
                <Link to={`/product/${movie.id}`}>
                  {movie.poster_path === null ? <img className="products-img" src={NoImage} alt="card"></img> : <img className="products-img" src={`https://image.tmdb.org/t/p/w500/${movie.poster_path}`} alt="Card"></img>}
                </Link>
